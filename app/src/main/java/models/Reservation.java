...
public class Reservation {
    ...
    public Double total; // Total cost of the reservation

    // Constructor
    public Reservation(Client client, Car car, String locationLong, String locationLat, Date dateStart, Date dateEnd, boolean driver, Double total) {
        this.client = client;
